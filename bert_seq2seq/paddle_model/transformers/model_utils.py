...
from bert_seq2seq.paddle_model.utils.downloader import get_path_from_url, COMMUNITY_MODEL_PREFIX
from bert_seq2seq.paddle_model.utils.env import MODEL_HOME
from bert_seq2seq.paddle_model.utils.log import logger
...
class PretrainedModel(Layer, GenerationMixin):
    ...
    def _wrap_init(self, original_init, *args, **kwargs):
        ...
        `__init__` as a attribute named `model` of the pretrained model instance.
        """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *args, **kwargs):
        ...
        Args:
            pretrained_model_name_or_path (str): Name of pretrained model or dir path
                ...
                - Local directory path which contains model weights file("model_state.pdparams")
                  and model model file ("model_config.json").
        ...
        # Check if the loaded model matches the current model class's __init__
        # arguments. If not match, the loaded model is for the base model class.
        if init_class == cls.base_model_class.__name__:
            ...
            derived_kwargs = {}
            base_arg_index = None
        else:  # extract model for base model
